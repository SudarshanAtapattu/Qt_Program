...
public:
    ...
    void setupUi(QDialog *ContactInfo)
    {
        ...
        txt_sarchk->setGeometry(QRect(20, 20, 321, 26));
        radioButton = new QRadioButton(groupBox_2);
        radioButton->setObjectName(QString::fromUtf8("radioButton"));
        radioButton->setGeometry(QRect(540, 10, 118, 24));
        radioButton->setCursor(QCursor(Qt::PointingHandCursor));
        radioButton_2 = new QRadioButton(groupBox_2);
        radioButton_2->setObjectName(QString::fromUtf8("radioButton_2"));
        radioButton_2->setGeometry(QRect(540, 50, 118, 24));
    ...
    void retranslateUi(QDialog *ContactInfo)
    {
        ...
        btn_loadContact->setText(QCoreApplication::translate("ContactInfo", "Refersh", nullptr));
